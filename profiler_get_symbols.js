...
__exports.get_compact_symbol_table = function(binary_data, debug_data, breakpad_id) {
    ...
    var ptr0 = passStringToWasm0(breakpad_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len0 = WASM_VECTOR_LEN;
    var ret = wasm.get_compact_symbol_table(binary_data.ptr, debug_data.ptr, ptr0, len0);
...
class CompactSymbolTable {
    ...
    */
    constructor() {
        var ret = wasm.compactsymboltable_new();
        return CompactSymbolTable.__wrap(ret);
    }
    /**
    * @returns {Uint32Array}
    */
    take_addr() {
        wasm.compactsymboltable_take_addr(8, this.ptr);
    ...
    */
    take_index() {
        wasm.compactsymboltable_take_index(8, this.ptr);
        var r0 = getInt32Memory0()[8 / 4 + 0];
        var r1 = getInt32Memory0()[8 / 4 + 1];
        var v0 = getArrayU32FromWasm0(r0, r1).slice();
        wasm.__wbindgen_free(r0, r1 * 4);
    ...
    */
    take_buffer() {
        wasm.compactsymboltable_take_buffer(8, this.ptr);
        var r0 = getInt32Memory0()[8 / 4 + 0];
        var r1 = getInt32Memory0()[8 / 4 + 1];
...
async function init(input) {
    ...
    imports.wbg.__wbg_call_9c879b23724d007e = handleError(function(arg0, arg1, arg2) {
