...
pub struct SourceApiQueryState<FT: FileTypes> {
    state: SourceState<FT>,
}

enum SourceState<FT: FileTypes> {
    AwaitingSymbolMap {
...
impl<FT: FileTypes> SourceApiQueryState<FT> {
...
impl<FT: FileTypes> ApiQueryState<FT> for SourceApiQueryState<FT> {
