    ...
    open_trace(Path::new(&std::env::args().nth(1).unwrap()), |e| {
        ...
        if let Ok(s) = s {
            ...
            match e.EventHeader.ProviderId {
                ...
                GUID{ data1: 0xa688ee40, data2: 0xd8d9, data3: 0x4736, data4: [0xb6, 0xf9, 0x6b, 0x74, 0x93, 0x5b, 0xa3, 0xb1]} => "D3DUmdLogging ",
                GUID{ data1: 0x3d6fa8d3, data2: 0xfe05, data3: 0x11d0, data4: [0x9d, 0xda, 0x00, 0xc0, 0x4f, 0xd7, 0xba, 0x7c]} => "PageFault_V2 ",
                _ => ""
            };
