...
impl FrameTable {
    ...
    pub fn index_for_frame(
        ...
        match frame.key.variant {
            ...
            InternalFrameKeyVariant::Native {
                ...
                if !global_lib_index_to_thread_string_index.contains_key(&lib) {
                    let lib_name = &global_libs.get_lib(lib).unwrap().name;
                    let lib_name = string_table.index_for_string(lib_name);
                    global_lib_index_to_thread_string_index.insert(lib, lib_name);
                }
            }
        }
    ...
    pub fn set_frame_source_location(
        ...
        self.file_col[frame] = file_path;
        self.line_col[frame] = line;
        self.column_col[frame] = col;
    }
