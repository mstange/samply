...
impl Thread {
    ...
    pub fn set_frame_source_location(&mut self, frame: usize, file_path: Option<ThreadInternalStringIndex>, line: Option<u32>, col: Option<u32>) {
        self.frame_table.set_frame_source_location(frame, file_path, line, col);
    }
