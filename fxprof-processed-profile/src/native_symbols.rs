    ...
    pub fn new_table_with_symbols_from_libs_removed(
        ...
        while old_index < old_len {
            ...
            if libs.contains(&lib_index) {
                ...
                // Retain.
                old_index_to_new_index[old_index] = new_index as u32;
                ...
                self.lib_and_symbol_address_to_symbol_index.insert((lib_index, address), new_index);
