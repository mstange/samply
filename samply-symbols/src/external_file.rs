...
use crate::dwarf::{get_frames, Addr2lineContextData, PathInterner};
        ...
        match (&self.member_contexts, external_file_address) {
            ...
            (
                ...
                match member_contexts.get(name_in_archive) {
                    Some(member_context) => member_context.lookup(symbol_name, *offset_from_symbol, path_interner),
                    None => {
                        ...
                        let res = member_context.lookup(symbol_name, *offset_from_symbol, path_interner);
