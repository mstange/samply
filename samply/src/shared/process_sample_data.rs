use fxprof_processed_profile::{
    Category, CategoryColor, CategoryHandle, LibMappings, MarkerFieldFlags, MarkerFieldFormat,
    MarkerTiming, Profile, StaticSchemaMarker, StaticSchemaMarkerField, StringHandle,
